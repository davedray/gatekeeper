...
import RolePicker from "../../roles/containers/picker";
interface props {
    ...
    return (
        <RelatedDrawer
            emptyState={<NonIdealState
                ...
                action={<RolePicker onSelect={onAddRole} roles={roles}/>}
            />}
        ...
        >
            ...
            <div style={{padding: '0 10px'}}>
                <RolePicker onSelect={onAddRole} roles={roles} filterIds={selectedRoleIds}/>
            </div>
        </RelatedDrawer>
    );
}
